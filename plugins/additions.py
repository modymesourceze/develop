...
async def source(c, msg):
    await msg.edit(
        "• [:-#🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱](https://t.me/Source_Ze)\n• [:-#⧛ 𓆩 𝑴𝒐𝒅𝒚 ➫ ⁽𝑆₎𝑻𝒆𝒂𝒎 ࿐ 𝑫 𝒆 𝒗 𝒊 𝒍 𓆪 ⧚ ](https://t.me/ELHYBA)\n•")
...
async def tarq(c, msg):
    await msg.edit(
        "**⎈ ⦙  - 𝑩𝑰𝑶 𝑳𝑰𝑺𝑻 : **\n𓍹ⵧⵧⵧⵧⵧⵧٍّ᥉᥆υᖇᥴᥱ ɀᥱⵧⵧⵧⵧⵧⵧ𓍻\n **⎈ ⦙  قائـمه البايو :** \n⎈ ⦙  `.بايو1 ` \n⎈ ⦙  `.بايو2` \n⎈ ⦙  `.بايو3 ` \n⎈ ⦙  `.بايو4 ` \n⎈ ⦙  `.بايو5` \n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧٍّ᥉᥆υᖇᥴᥱ ɀᥱⵧⵧⵧⵧⵧⵧⵧⵧ𓍻")   
